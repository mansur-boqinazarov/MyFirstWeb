...
<div class="todo-container">
    ...
    <div class="todo-item">
        ...
        <div class="todo-details">
            <p><strong>Description:</strong> <i><%= todo.getDescription() %>
            </i></p>
            <p><strong>Create Date:</strong> <i><%= todo.getCreated_at() %>
            </i></p>
            <p><strong>Due Date:</strong> <i><%= todo.getDue_date() %>
            </i></p>
            <a class="download-link" href="download?fileId=<%= todo.getFile_id() %>">Download</a>
